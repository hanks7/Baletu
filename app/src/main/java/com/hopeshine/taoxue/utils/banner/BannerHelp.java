...
public class BannerHelp {
    ...
    public void addData(List<BdqdBean> textUrlList) {
        mBanner.setPages(
     ...
     * 广告轮播内部类
     */
    class LocalIImageHolderView implements Holder<BdqdBean> {
        ...
        @Override
        public void UpdateUI(Context context, final int position, BdqdBean data) {
            UtilGlide.loadImg(context, data.getResource_picture(), imageView);
        }
    }
}
